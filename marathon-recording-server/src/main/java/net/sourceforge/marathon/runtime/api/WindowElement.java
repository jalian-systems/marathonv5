...
public class WindowElement extends CompositeScriptElement {
    ...
    public static final Logger LOGGER = Logger.getLogger(WindowElement.class.getName());
    ...
    @Override public String toScriptCode() {
        ...
        Indent.decIndent();
        buffer.append(Indent.getIndent() + RecordingScriptModel.getModel().getScriptCodeForWindowClose(windowId));
