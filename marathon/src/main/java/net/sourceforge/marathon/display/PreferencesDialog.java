...
public class PreferencesDialog extends EscapeDialog {
    ...
    public PreferencesDialog(JFrame parent) {
        ...
        JPanel buttonPanel = ButtonBarFactory.buildRightAlignedBar(defaultsButton, okButton, cancelButton);
    ...
    private JPanel getPreferencesPanel() {
        ...
        doNotHideMarathonITEBlurbs.addActionListener(new ActionListener() {
            @Override public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(PreferencesDialog.this, "Restart Marathon for this option to take effect",
