...
/**
 * Represents the known and supported Platforms that WebDriver runs on. This is
 * pretty close to the Operating System, but differs slightly, because this
 * class is used to extract information such as program locations and line
 * endings.
 */
// Useful URLs:
...
public enum Platform {
    ...
    /**
     * Never returned, but can be used to request a browser running on any
     * version of Windows.
     */
    WINDOWS("") {
        @Override
    ...
    /**
     * For versions of Windows that "feel like" Windows XP. These are ones that
     * store files in "\Program Files\" and documents under "\\documents and
     * settings\\username"
     */
