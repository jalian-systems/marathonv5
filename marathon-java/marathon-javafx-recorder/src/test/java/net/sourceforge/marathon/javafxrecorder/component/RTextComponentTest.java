...
import net.sourceforge.marathon.javafxrecorder.component.RTextComponent;
...
@Test public class RTextComponentTest extends RComponentTest {
    ...
    public void select() throws InterruptedException, InvocationTargetException {
        ...
        net.sourceforge.marathon.javafxrecorder.component.LoggingRecorder.Call call = lr.getCall();
