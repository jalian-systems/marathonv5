...
@Test public class JSpinner2Test {
    ...
    public void chooseValues() throws Throwable {
        ...
        Integer previousYear = Integer.parseInt(sYear) - 1;
        spinnerMonthDown.click();
        AssertJUnit.assertEquals("December", spinnerMonth.getAttribute("value"));
        AssertJUnit.assertEquals(previousYear.toString(), spinnerYear.getAttribute("value"));
        ...
        for (int i = 0; i < months.length - 1; i++) {
            ...
            String selctedMonth = spinnerMonthField.getText();
            if (selctedMonth.equals("December")) {
                spinnerMonthUp.click();
        ...
        String cYear = spinnerYear.getAttribute("value");
        spinnerYearUp.click();
        Integer nextYear = Integer.parseInt(cYear) + 1;
        AssertJUnit.assertEquals(nextYear.toString(), spinnerYear.getAttribute("value"));
