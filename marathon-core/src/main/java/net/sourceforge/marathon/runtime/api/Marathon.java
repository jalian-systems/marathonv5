...
public class Marathon {
	...
	public void click(Object componentName, boolean isPopupTrigger, Object o1, Object o2, Object o3, Object o4,
			Object o5) {
		sleepForSlowPlay();
	...
	public void assertContentJava(String[][] expected, String actual) {
		...
		for (int i = 0; i < o.length(); i++) {
			if (expected[i].length != o.getJSONArray(i).length()) {
				throw new AssertionFailedError("Invalid Length at index " + i + ", "
	...
	public String getErrorScreenShotFile() {
		...
		if (captureDir != null) {
			...
			String errorFile = captureDir + File.separator + prefix + "-error" + Integer.toString(files.length + 1)
					+ ".png";
			return errorFile;
		}
		return null;
	...
	public void clickInternal(ComponentId id, Point position, int clickCount, String modifiers,
