...
public class FXBareRuntimeLauncherModel implements IRuntimeLauncherModel {

    public static final Logger LOGGER = Logger.getLogger(FXBareRuntimeLauncherModel.class.getName());
