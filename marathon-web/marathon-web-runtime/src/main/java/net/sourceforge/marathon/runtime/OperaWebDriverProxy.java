...
public class OperaWebDriverProxy implements IWebBrowserProxy {

    public static final Logger LOGGER = Logger.getLogger(OperaWebDriverProxy.class.getName());

    public static final String BROWSER = DesiredCapabilities.operaBlink().getBrowserName();
    ...
    private static class OperaBrowserTab extends BrowserTab {
        public OperaBrowserTab(String name) {
            super(name);
        }
        ...
        public String getExtensionDescription() {
            return "Opera Browser Extensions";
        }
    ...
    public BrowserTab getTab(String name) {
        return new OperaBrowserTab(name);
    }
    ...
    public Map<String, ?> getCapabilities() {
        ...
        caps.put("operaOptions", chromeOptions);
