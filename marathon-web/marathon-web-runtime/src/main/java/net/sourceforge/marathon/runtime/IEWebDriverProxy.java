...
public class IEWebDriverProxy implements IWebdriverProxy {

    private int port;
    private InternetExplorerDriverService service;

    public IEWebDriverProxy() {
        port = findPort();
        InternetExplorerDriverService.Builder builder = new InternetExplorerDriverService.Builder();
        service = builder.usingPort(port).withLogFile(new File("internetexplorer.log"))
