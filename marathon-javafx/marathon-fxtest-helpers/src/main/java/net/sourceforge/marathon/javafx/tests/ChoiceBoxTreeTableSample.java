...
public class ChoiceBoxTreeTableSample extends Sample {
    ...
    public ChoiceBoxTreeTableSample() {
        ...
        empColumn.setCellFactory(ChoiceBoxTreeTableCell.forTreeTableColumn(items));
