...
public class RFXListViewTest extends RFXComponentTest {
	...
	public void selectSpecialItemSelection() {
		...
		AssertJUnit.assertEquals(" Special Characters ([],)", text.get(0));
	}
	...
	public void selectDuplicate() {
		...
		AssertJUnit.assertEquals("Row 9", text.get(0));
		...
		AssertJUnit.assertEquals("Row 9(1)", text.get(0));
	}
	...
	public void listMultipleDuplicates() {
		...
		AssertJUnit.assertEquals("Row 9(2)", text.get(0));
	}
