...
public class RFXComponentFactory {
	...
	private static class InstanceCheckFinder implements IRComponentFinder {
		...
		public InstanceCheckFinder(Class<? extends Node> componentKlass,
				Class<? extends RFXComponent> javaElementKlass) {
	...
	public RFXComponent findRComponent(Node parent, Point2D point, IJSONRecorder recorder) {
		return findRawRComponent(getComponent(parent), point, recorder);
	}
	...
	public Node getComponent(Node component) {
