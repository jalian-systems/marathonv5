...
public class MarathonBuilder extends Builder {
	...
	public MarathonBuilder(String marathonHome, String mProjectDir, String testCases) {
	...
	public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
		...
		public FormValidation doCheckMarathonHome(@QueryParameter String marathonHome,
		...
		public FormValidation doCheckMProjectDir(@QueryParameter String mProjectDir,
				@AncestorInPath AbstractProject project) throws IOException, ServletException {
		...
		public FormValidation doCheckTestCases(@QueryParameter String testCases,
				@AncestorInPath AbstractProject project) throws IOException, ServletException {
